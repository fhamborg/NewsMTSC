...
If you only want to use the dataset, you can [download it here](https://github.com/fhamborg/NewsMTSC/blob/main/controller_data/datasets/NewsMTSC-dataset/NewsMTSC-dataset.zip)
