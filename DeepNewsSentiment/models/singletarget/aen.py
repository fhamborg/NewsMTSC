...
from DeepNewsSentiment.layers.attention import Attention
from DeepNewsSentiment.layers.point_wise_feed_forward import PositionwiseFeedForward
from DeepNewsSentiment.layers.squeeze_embedding import SqueezeEmbedding
