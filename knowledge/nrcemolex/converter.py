...
PATH_DICT_NRC_EMOLEX = Path(
    "knowledge/nrcemolex/NRC-Emotion-Lexicon-Wordlevel-v0.92.txt.ddict"
)
...
def convert_txt_to_dict():
    path_dict = Path("knowledge/nrcemolex/NRC-Emotion-Lexicon-Wordlevel-v0.92.txt")
